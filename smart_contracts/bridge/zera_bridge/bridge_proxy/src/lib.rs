pub mod bridge_proxy {
    ...
    pub fn init() {
        unsafe{
            ...
            let smart_contract_state = SmartContractState {
                smart_contract: "bridge_v1".to_string(),
                instance: "1".to_string(),
                sc_gov: "bridge_gov_v1".to_string(),
    ...
    pub fn execute_gov(function: String, parameters: String) {
        unsafe{
            ...
            let results = smart_contracts::delegatecall(sc_gov_state.sc_gov.clone(), sc_gov_state.sc_gov_instance.clone(), function.clone(), parameters_vec.clone());
    ...
    pub fn update_gov(smart_contract: String, instance: String)  {
        unsafe{
            ...
            save_state(SMART_CONTRACT_KEY, &sc_gov_state);
