pub mod ace_proxy {
    ...
    pub fn init() {
        unsafe{
            ...
            let smart_contract_state = SmartContractState {
                smart_contract: "zra_v1".to_string(),
            ...
            smart_contracts::store_state(ACE_SC.to_string(), "zra_v1_1".to_string());
        }
    }
    ...
    pub fn update(smart_contract: String, instance: String) {
        unsafe{
            ...
            smart_contracts::store_state(ACE_SC.to_string(), network_state.to_string());
