pub mod restricted_symbols_proxy {
    ...
    const RESTRICTED_SC: &str = "RESTRICTED_SC";
    ...
    pub fn init() {
        unsafe{
            ...
            let smart_contract_state = SmartContractState {
                smart_contract: "restricted_symbols_v1".to_string(),
                instance: "1".to_string(),
            };

            smart_contracts::store_state(RESTRICTED_SC.to_string(), "restricted_symbols_v1_1".to_string());
    ...
    pub fn update(smart_contract: String, instance: String) {
        unsafe{
            ...
            smart_contracts::store_state(RESTRICTED_SC.to_string(), network_state.to_string());
