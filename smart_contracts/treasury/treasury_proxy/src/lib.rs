pub mod zera_treasury_proxy {
    ...
    const GOV_WALLET: &str = "46oLKvxWo9JASRrhJN3i4FDBhJPXTCgr1GtTe8pe8ECc";
    ...
    pub fn init() {
        unsafe {
            ...
            let smart_contract_state = SmartContractState {
                smart_contract: "zera_treasury_v1".to_string(),
    ...
    pub fn send_all() {
        unsafe {
            ...
            smart_contracts::send_all(GOV_WALLET.to_string());
        }
    }
